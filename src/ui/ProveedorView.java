...
public class ProveedorView {
	...
	public void listar(ProveedorController proveedorController) {
		//Configuro la pantalla de listar
	        ...
	        String[] nombresColumnas = {"Cuit", "Razón Social", "Nombre", "Telefono", "Correo", "Inicio Actividades","Max Deuda", "Eliminar"};
	        ...
	        columnaBoton.setCellRenderer(new BotonEliminar());
		...
		agregarProveedor.addActionListener(e -> {
	        ...
	        /*dateTextField.addFocusListener(new FocusAdapter() {
	            ...
	            public void focusLost(FocusEvent e) {
	                validateDate(dateTextField);
	            }
	        });*/
	        panel.add(dateTextField);
	        
	        /*Rubros*/
	        Map<JCheckBox, Rubro> checkBoxesMap = new HashMap<>(); //Este map es para vincular los checkbox con los enum
			/*Medicina Prepaga*/
			...
			botonAgregar.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					Date parsedDate = validateDate(dateTextField); //Valido la fecha, si es correcta se guarda en parsedDate, sino se muestra el eror en consola
					if(parsedDate == null) {
					...
					ProveedorDto pDto = new ProveedorDto(
						    ...
						    razonSocialText.getText(),
						    nombreTexto.getText(),
						    Integer.parseInt(telefonoTexto.getText()),
						    correoTexto.getText(),
						    parsedDate,
						    rubrosSeleccionados,
						    Float.parseFloat(deudaMaximaTexto.getText()),
						    calleTexto.getText(), 
						    Integer.parseInt(alturaTexto.getText()), 
						    Integer.parseInt(codigoPostalTexto.getText()), 
						    paisTexto.getText(), 
						    provinciaTexto.getText(), 
						    ciudadTexto.getText()
						);
	...
	private void quitar(ProveedorController proveedorController) {
